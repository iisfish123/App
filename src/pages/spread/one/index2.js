...
class SpreadOne2 extends Component {
    imageCode = '';
    ...
    getMessageCode = () => {
        ...
        hmCount({category: '推广1chl=' + getChlFormUrl(), opt_label: '获取验证码'});
    ...
    toLoan = () => {
        ...
        hmCount({category: '推广1chl=' + getChlFormUrl(), opt_label: '点击注册'});
